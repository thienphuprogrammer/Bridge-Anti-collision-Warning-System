...
def dlt_homography(x: np.ndarray, xp: np.ndarray) -> np.ndarray:
    ...
    :param x : numpy.array, shape (3, nr_points)
            2D points in homogeneous format
    :param xp : numpy.array, shape (3, nr_points)
            2D points in homogeneous format
    :return Returns
        H : numpy.array
...
def transformation_scale(
    ...
    :param K : numpy.array, shape (3, 3)
            Camera intrinsic matrix
    :param R : numpy.array, shape (3, 3)
            Rotation matrix
    :param t : numpy.array, shape(3, 1)
            Translation vector
    :param uv : numpy.array, shape(3, 1)
            Point uv seen in the image plane
    :param x : numpy.array, shape(3, 1)
